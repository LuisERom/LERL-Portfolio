...
/**
 * Section wrapper with the heading “I’m interested in…” and a 2-column grid of small themed panels.
 * Each cell imports its own animated widget (brain, terminal) so this file mostly handles layout and motion on scroll.
 */
